...
class LayoutsControllerTest < ActionController::TestCase
  ...
  test "should create layout" do
    assert_difference('Layout.count') do
      post :create, layout: { file_location: @layout.file_location, floor_id: @layout.floor_id, description: @layout.description }
    end
  ...
  test "should update layout" do
    patch :update, id: @layout, layout: { file_location: @layout.file_location, floor_id: @layout.floor_id, description: @layout.description }
    assert_redirected_to layout_path(assigns(:layout))
  end
